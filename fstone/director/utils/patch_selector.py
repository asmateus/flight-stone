...
from utils.config import loadConfigInstance, saveDefaultConfig
...
class PatchSelectorManager:
    ...
    PERSISTENT_COPY_PATH = PTH + 'fstone/director/utils/seeds/'
    INTERACTION_METHODS = {
        'terminal': 1,
        'graphical': 2,
        'interactive': 3,
    ...
    def setAsDefaultPatch(self, pname):
        configs = loadConfigInstance()
        configs['default_patch_name'] = pname
        saveDefaultConfig(configs)
