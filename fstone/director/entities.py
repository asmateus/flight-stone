class Director:
    ...
    def manageEventResponse(self, ev_type, rs):
        if self.extended_manager:
            ...
            manager.writeController(idm, ('master said: ' + rs).encode('utf-8'))
        print('Got:', rs, 'event from', str(ev_type))

    def assignExtendedController(self, controller_id, controller):
        self.extended_manager = (controller_id, controller)
